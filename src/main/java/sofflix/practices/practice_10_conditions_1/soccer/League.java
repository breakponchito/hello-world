 ...
 */
package sofflix.practices.practice_10_conditions_1.soccer;
...
public class League {
    ...
    public void showBestTeam(Team[] theTeams){
        Team currBesTeam = theTeams[0];
        
        System.out.println("\nTeam Points");
        for (Team currTeam : theTeams) {
            System.out.println(currTeam.getTeamName() + ":" + currTeam.getPointsTotal());
            currBesTeam = currTeam.getPointsTotal() > currBesTeam.getPointsTotal()?currTeam:currBesTeam;
        }
        System.out.println("Winner of the league is " + currBesTeam.getTeamName());
    }
}
