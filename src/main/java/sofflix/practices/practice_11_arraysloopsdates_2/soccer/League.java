 ...
 */
package sofflix.practices.practice_11_arraysloopsdates_2.soccer;
...
import sofflix.practices.practice_11_arraysloopsdates_2.utility.PlayerDatabase;
...
public class League {
    ...
    public String getLeagueAnnouncement (Game[] theGames){
        ...
        returnString.append(thePeriod.getMonths() + " month(s), and ");
        returnString.append(thePeriod.getDays() + " day(s)\n");
